...
echo "test 1 : ";
$req = shell_exec('./day02/ex00/another_world.php "beruivb 	 	 	 vniurtb.  h ferhubv"');
...
echo "test 2 : ";
$req = shell_exec('./day02/ex00/another_world.php "beruivb 	 	 	 vniurtb.  h ferhubv" "ncueibvueribvyueby.        hbyug"');
if ($req == "beruivb vniurtb. h ferhubv\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 3 : ";
$req = shell_exec('./day02/ex00/another_world.php');
if ($req == "") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 1 : ";
$req = shell_exec('./day02/ex01/one_more_time.php "Mardi 12 Novembre 2013 12:02:21"');
if ($req == "1384254141\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 2 : ";
$req = shell_exec('./day02/ex01/one_more_time.php "Mercreday 1stJuily 99"');
if ($req == "Wrong Format\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 3 : ";
$req = shell_exec('./day02/ex01/one_more_time.php');
if ($req == "") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 4 : ";
$req = shell_exec('./day02/ex01/one_more_time.php "Samedi 1 Décembre 2018 20:12:59"');
if ($req == "1543691579\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 6 : ";
$req = shell_exec('./day02/ex01/one_more_time.php "samedi 1 Decembre 2018 20:12:60"');
if ($req == "Wrong Format\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
$req = shell_exec('./day02/ex01/one_more_time.php "samedi 2 Decembre 2018 20:12:56"');
if ($req == "Wrong Format\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
$req = shell_exec('./day02/ex02/loupe.php page.html > day02/new_page.html');

if (file_get_contents("day02/new_page.html") == $rep) {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
}
...
echo "test 1 : ";
$tab = shell_exec('who');
$tab1 = shell_exec('./day02/ex03/who.php');
if ($tab == $tab1) {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 2 : ";
exec('./day02/ex04/photos.php "http://www.42.fr"');
...
echo "test 1 : ";
$req = shell_exec('./day02/ex06/srt.php rss/day02/test.srt');
$res = "1
